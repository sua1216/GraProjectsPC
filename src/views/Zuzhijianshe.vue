    ...
    <div class="zu-zhi-jian-she">
        <div class="page-header">
            <div class="page-header-item">
                <!-- //一层楚雄-->
                <div :data="dataSource" v-if="CengJi==1">{{dataSource[0].zuzhi}}</div>
                <!--//一层-->
                <div :data="dataSource" v-if="CengJi==2">{{dataSource[this.dangNum].zuzhi}}</div>
                <!-- //二层-->
                <div :data="dataSource1" v-if="CengJi==3 ">{{dataSource1[this.preNum1][this.dangNum].zuzhi}}</div>
                <!-- //三层-->
                <div :data="dataSource2" v-if="CengJi==4 ">{{dataSource2[this.preNum2][this.dangNum].zuzhi}}</div>
                <!--//四层-->
                <div :data="dataSource3" v-if="CengJi==5 ">{{dataSource3[this.preNum3][this.dangNum].zuzhi}}</div>
                <div>党组织数量</div>
            </div>
            <div class="page-header-item">
                <!-- //一层楚雄-->
                <div :data="dataSource" v-if="CengJi==1">{{dataSource[0].dangyuan}}</div>
                <!--//一层-->
                <div :data="dataSource" v-if="CengJi==2">{{dataSource[this.dangNum].dangyuan}}</div>
                <!-- //二层-->
                <div :data="dataSource1" v-if="CengJi==3 ">{{dataSource1[this.preNum1][this.dangNum].dangyuan}}</div>
                <!-- //三层-->
                <div :data="dataSource2" v-if="CengJi==4 ">{{dataSource2[this.preNum2][this.dangNum].dangyuan}}</div>
                <!--//四层-->
                <div :data="dataSource3" v-if="CengJi==5 ">{{dataSource3[this.preNum3][this.dangNum].dangyuan}}</div>
                <div>党员数量</div>
            </div>
        </div>
        <div class="bottomMiddle">
            <div>
                ...
                <span v-if="CengJi < 4"> <img src="../assets/common/images/ZuZhiJianShe/point_djyl_l@2x.png" height="59" width="49"/>成员党组织</span>
...
<script>
    ...
    //左右组件
    import ZuZhiJianSheRight from '@/components/pages/ZuZhiJianShe/ZuZhiJianSheRight.vue';
    import ZuZhiJianSheLeft from '@/components/pages/ZuZhiJianShe/ZuZhiJianSheLeft.vue';
    // 一级marker
...
/*                    {"lnglat": [101.49593155318047, 25.11811675509246], "didian": "本东村委会"},*/
                ...
                dataSiqiye: [
                    [[101.51123166307269, 25.071380820353596], [101.50489790362974, 25.069709505510758], [101.51376768164855, 25.070041937843982],],
                    [[101.52856820102181, 25.059748658475613], [101.53857025524826, 25.071301407540474], [101.52989349103439, 25.076890484051404],],
                ],
                dataSiJiGuan: [
                ...
                dataSource1: [
                    ...
                    [
                        {name: '妥甸镇党委', zuzhi: 1, dangyuan: 1},
                        {name: '大庄镇党委', zuzhi: 2, dangyuan: 1},
                        {name: '法脿镇党委', zuzhi: 3, dangyuan: 1},
                        {name: '鄂嘉镇党委', zuzhi: 4, dangyuan: 1},
                        {name: '大麦地镇党委', zuzhi: 5, dangyuan: 1},
                        {name: '安龙堡乡党委', zuzhi: 6, dangyuan: 1},
                        {name: '爱尼山乡党委', zuzhi: 7, dangyuan: 1},
                        {name: '独田乡党委', zuzhi: 8, dangyuan: 1},
                    ],
                    [
                        {name: '共和镇党委', zuzhi: 11, dangyuan: 1},
                        {name: '新桥镇党委', zuzhi: 12, dangyuan: 1},
                        {name: '江坡镇党委', zuzhi: 13, dangyuan: 1},
                        {name: '凤屯镇党委', zuzhi: 14, dangyuan: 1},
                        {name: '蟠猫乡党委', zuzhi: 15, dangyuan: 1},
                        {name: '戌街乡党委', zuzhi: 16, dangyuan: 1},
                        {name: '安乐乡党委', zuzhi: 17, dangyuan: 1},
                        {name: '蟠猫乡', zuzhi: 18, dangyuan: 1},
                    ],
                    [
                        {name: '龙川镇党委'},
                        {name: '沙桥镇党委'},
                ...
                dataSource2: [
                    [
                        {name: '东瓜社区', zuzhi: 1, dangyuan: 266},
                        {name: '永安社区', zuzhi: 2, dangyuan: 266},
                        {name: '车坪社区', zuzhi: 3, dangyuan: 266},
                        {name: '詹家社区', zuzhi: 4, dangyuan: 266},
                        {name: '庄甸社区', zuzhi: 5, dangyuan: 266},
                        {name: '刘家社区', zuzhi: 6, dangyuan: 266},
                        {name: '永兴社区', zuzhi: 7, dangyuan: 266},
                        {name: '邓官社区', zuzhi: 8, dangyuan: 266},
                        {name: '桃园社区', zuzhi: 9, dangyuan: 266},
                        {name: '览经社区', zuzhi: 10, dangyuan: 266},
                    ],
        ...
        created() {
            this.leftcomponent = ZuZhiJianSheLeft;
            this.rightcomponent = ZuZhiJianSheRight;
        },
        computed: {
            map: function () {
        ...
        methods: {
            ...
            fly3(index) {
                ...
                if (index == 0) {
                    ...
                    this.removeMarker(this.marker)
                    this.setChongXiongShi([this.dataSiJiCenterOne[index]])
                    /* this.setQiYe([[this.dataSiqiye[0]]]);*/
                    this.setJiGuan(this.dataSiJiGuan);
                    this.setShiYeDanWei(this.dataSiShiYe);
                    this.setXueXiao(this.dataSiXueXiao)
                }
            ...
            /*   grid4(index) {
                   let grid4Features = [];
                   for(let i in grid4[index]){
                           grid4Features.push({
                               type: 'Feature',
                               geometry: {
                                   type: 'Polygon',
                                   coordinates: [grid4[index][i].points]
                               }
                           })

                   }
                   console.log(grid4Features);*/
            grid4() {
            ...
            //             let options = {
            //                 lnglat:this.markerData.keyArea[i].lnglat,
            //                 vuecp:keyArea,
            //                 props:{
            //                     d:this.markerData.keyArea[i]
            //                 }
            //             }
            //             this.markerBox.keyArea.push(this.makeVueMarker(options),this.map)
            //         }
            //         try {
