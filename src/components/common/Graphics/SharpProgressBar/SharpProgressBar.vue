            ...
            <g >
                <defs>
                    <linearGradient id="gradient1" x1="0%" x2="100%">
                        <stop offset="0" style="stop-color:#F70028;stop-opacity:.1"></stop>
                        <stop offset="1" style="stop-color:#F70028;stop-opacity:.7"></stop>
                    </linearGradient>
                </defs>
                <text x="30" y="20" text-anchor="middle" dominant-baseline="middle" fill="white"><!--{{d&&d[0].month}}-->6月</text>
                <path  stroke='#F70028' stroke-width='0.5' :d="top" fill="url(#gradient1)"></path>
                <text x="400" y="20" text-anchor="middle" dominant-baseline="middle" fill="white">5236</text>
            </g>
            <g>
                <defs>
                    <linearGradient id="gradient2" x1="0%" x2="100%">
                        <stop offset="0" style="stop-color:#FFFFFF;stop-opacity:.1"></stop>
                        <stop offset="1" style="stop-color:#FFFFFF;stop-opacity:.7"></stop>
                    </linearGradient>
                </defs>
                <text x="30" y="60" text-anchor="middle" dominant-baseline="middle" fill="white"><!--{{d&&d[1].month}}-->5月</text>
                <path stroke='#FFFFFF' stroke-width='0.5' :d="bottom" fill="url(#gradient2)"></path>
                <text x="400" y="60" text-anchor="middle" dominant-baseline="middle" fill="white">163131</text>
            </g>
        </svg>
    </div>
</template>
