<template>
    <div class="pt-lvmaoozi" @mouseenter="isOnHover(true)" @click="showPerson" @mouseleave="isOnHover(false)">
        ...
        <div class="namebox1" :title="d.dept_name">{{d.dept_name}}</div>
        <div class="numbox1" :title="d.num">{{d.num}}</div>
...
<style scoped>
    ...
    .numbox1 {
        ...
        padding: 0 5px;
        font-size: 24px;
        text-shadow: 0.05rem 0rem .5rem rgba(0,0,0,0.2),-0.05rem 0rem .5rem rgba(0,0,0,0.2),0rem 0.05rem .5rem rgba(0,0,0,0.2),0rem 0.05rem .5rem rgba(0,0,0,0.2);
    ...
    .pt-lvmaoozi .pt-lvcircle{
        ...
        z-index: 2;
        /*border-radius: 20px;*/
        /*border: 1px solid #26F085;*/
        /*box-shadow: 0 0 10px rgba(38,240,133,.7);*/
        background: url("../../../../../public/images/point_wtfx_gzz@2x.png") no-repeat center;
