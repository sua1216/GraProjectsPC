<template>
	<div class="pt-lvmaoozi" @mouseenter="isOnHover(true)" @click="showPerson" @mouseleave="isOnHover(false)">
		...
		<div class="namebox1" v-show="isHover" :title="d.name+' '+d.dept_name">{{d.name}} {{d.dept_name}}</div>
...
<style scoped>
	...
	.pt-lvmaoozi .pt-lvcircle{
		...
		background: url("../../../../../public/images/point_wtfx_gzz@2x.png") no-repeat center rgba(24,36,58,0.9);
	}
	.pt-lvmaoozi .pt-disk{
		width: 68px;
		height: 68px;
