...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            showPerson(e){
                //console.log(3)
                if(this.parent.$store.state.clickYishouliMarker==true){
                    this.parent.$store.commit('hide')
                }else if(this.parent.$store.state.clickYishouliMarker==false){
                    this.parent.$store.commit('show')
                }
            }
        },
    }
