<template>
    <div class="pt-lvmaoozi" @mouseenter="isOnHover(true)" @click.stop="showPerson" @mouseleave="isOnHover(false)">
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            showPerson(e){
                this.parent.$store.commit('ZhuanyuanXQShow')
                var data = "专业网格员";
                this.parent.$store.commit('ZhuanyuanMsgChange',data)
                var position = [e.pageX,e.pageY]
                this.parent.$store.commit('changXQposition',position)
            }
        },
    }
</script>
...
<style scoped>
    ...
    .pt-lvmaoozi .namebox1{
        ...
        background: url("../../../../../public/images/zhuanzhiwanggeyuan3@2x.png") no-repeat center;
    ...
    .pt-lvmaoozi .pt-lvcircle{
        ...
        position: relative;
        z-index: 2;
        background: url("../../../../../public/images/zhuanzhiwanggeyuan2-1@2x.png") no-repeat center;
