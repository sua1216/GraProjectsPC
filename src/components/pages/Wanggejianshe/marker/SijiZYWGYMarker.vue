...
<style scoped>
    ...
    .pt-lvmaoozi .namebox1{
        ...
        background: url("../../../../../public/images/zhuanyewanggeyuan3@2x.png") no-repeat center;
    ...
    .pt-lvmaoozi .pt-lvcircle{
        ...
        position: relative;
        z-index: 2;
        background: url("../../../../../public/images/zhuanyewanggeyuan2-1@2x.png") no-repeat center;
