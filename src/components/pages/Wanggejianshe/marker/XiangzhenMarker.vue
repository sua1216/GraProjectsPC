<template>
    <div class="pt-lvmaoozi" @mouseenter="isOnHover(true)" @click="showPerson" @mouseleave="isOnHover(false)">
        ...
        <div class="namebox1" :title="d.id" v-if="nameShow">{{d.name}}</div>
...
<script>
    ...
    export default {
        ...
        mounted() {
            this.marker.getElement().style.position="absolute"
        ...
        methods:{
            ...
            // },
            isOnHover(status){
                this.nameShow=status
                if(status==true){
                    this.marker.getElement().style.position="absolute"
                    this.marker.getElement().style.zIndex=9999;
                }else {
                    this.marker.getElement().style.zIndex=1;
                }
...
<style scoped>
    ...
    .pt-lvmaoozi .namebox1{
        ...
        padding: 0 5px;
        z-index: 99999;
        /*-webkit-text-stroke: 1.0px rgb(19,19,19);*/
    }
